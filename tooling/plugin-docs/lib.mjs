...
export function extractPluginFacts(repoRoot) {
  ...
  const facts = {
    ...
    recommendedPlugins: parseArrayField(manifestText, "recommendedPlugins"),
    capabilityEnhancingPlugins: parseArrayField(manifestText, "capabilityEnhancingPlugins"),
    integrationOnlyPlugins: parseArrayField(manifestText, "integrationOnlyPlugins"),
    suggestedPacks: parseArrayField(manifestText, "suggestedPacks"),
    standaloneSupported: parseOptionalBooleanField(manifestText, "standaloneSupported"),
    installNotes: parseArrayField(manifestText, "installNotes"),
