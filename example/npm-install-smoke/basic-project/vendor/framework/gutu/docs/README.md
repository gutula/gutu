...
The specification sources are mirrored here so the repository layout matches the platform monorepo contract.

Current implementation layout note:

- framework runtime and shared libraries now live under `framework/core/` and `framework/libraries/`
