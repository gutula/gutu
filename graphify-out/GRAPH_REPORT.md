...
## Corpus Check
- 4185 files · ~6,934,636 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9663 nodes · 15009 edges · 77 communities detected
- Extraction: 69% EXTRACTED · 31% INFERRED · 0% AMBIGUOUS · INFERRED: 4686 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (514): accessibleRecordIds(), effectiveRole(), grantAcl(), listAcl(), purgeAclForRecord(), revokeAcl(), roleFromLinkToken(), seedDefaultAcl() (+506 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (304): canLaunchZone(), canRunAction(), canSeeField(), canSeeWidget(), canUseBuilder(), canUseCommand(), canViewPage(), canViewReport() (+296 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (232): decodeEncodedWords(), formatAddress(), formatAddresses(), isValidEmail(), normalizeEmail(), normalizeSubject(), parseAddress(), parseAddressList() (+224 more)
...
Cohesion: 0.01
Nodes (192): fmtCurrency(), mockKpis(), mockSeries(), money(), fmtCurrency(), mockKpis(), mockSeries(), AiEvalsRunDetailPage() (+184 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (205): runOrError(), safeJson(), apiBase(), createEditorRecord(), createPublicLink(), deleteEditorRecord(), fetchEditorRecord(), fetchSnapshot() (+197 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (163): fetchAll(), monthKey(), num(), str(), fetchAll(), num(), str(), fetchAll() (+155 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (105): AdvancedDataTable(), loadState(), addLeaf(), AdvancedFilterBuilder(), emit(), emptyLeaf(), isLeaf(), removeAt() (+97 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (126): isRecord(), normalizeEvent(), sanitizeJson(), asSeries(), countBadges(), parse(), assertRepositoryBoundary(), calculateNextRunAt() (+118 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (93): applyEncryption(), bufferUpTo(), concat(), existsFile(), fromS3StorageClass(), LocalStorageAdapter, nodeToWebStream(), renderPrefix() (+85 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (143): aggregate(), bucketKey(), computeAggregation(), evalFilter(), evalLeaf(), previousRange(), resolveTimeRange(), normaliseDate() (+135 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (109): cmdCreate(), cmdHelp(), cmdList(), cmdValidate(), die(), exists(), findIndex(), log() (+101 more)
...
Cohesion: 0.03
Nodes (77): AnalyticsEmitterImpl, createAnalytics(), ensureSessionId(), compileBiQuery(), createBiChart(), createBiDashboard(), createBiSchedule(), createBiShare() (+69 more)

### Community 17 - "Community 17"
Cohesion: 0.02
Nodes (86): bankAccounts(), bankTransactions(), budgets(), code(), costCenters(), count(), currencyRates(), dunning() (+78 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (85): createPaymentIdempotencyKey(), AiProviderError, convertZodSchema(), createErrorResponse(), createMcpRuntimeOrchestrator(), createMcpRuntimeServer(), createMcpServerFromContracts(), createSchemaCacheEntry() (+77 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (51): locales(), countConditionKeys(), backoffMs(), collectParticipants(), collectParticipantsFromMessages(), fetchJson(), fetchWithTimeout(), jmapAddrToAddress() (+43 more)
...
Cohesion: 0.04
Nodes (88): close(), closeDbx(), setDbxForTests(), resetRoomManager(), RoomManager, trigger(), main(), runScenario() (+80 more)
...
Cohesion: 0.05
Nodes (45): normalize(), toSnakeCase(), compileDraft(), compileEmailDraft(), createCommunicationIdempotencyKey(), createLocalCommunicationProviderRegistry(), createRetryDecision(), defineCommunicationRoute() (+37 more)
...
Cohesion: 0.23
Nodes (15): withLeadership(), cronMatches(), ensureRunsTable(), fieldMatches(), fireOnce(), getScheduleRunsForTest(), listTimeBasedRules(), recordsWithDateField() (+7 more)
...
Cohesion: 0.18
Nodes (2): getEditorBridge(), register()
...
- **Thin community `Community 37`** (26 nodes): `BusinessAdminPage()`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`, `main.page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (11 nodes): `getEditorBridge()`, `register()`, `resetEditorBridge()`, `index.ts`, `index.ts`, `index.ts`, `index.ts`, `index.ts`, `index.ts`, `index.ts`, `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 68`** (4 nodes): `NavIcon.js`, `NavIcon.tsx`, `NavIcon()`, `toPascal()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (3 nodes): `storage.ts`, `isSecretKey()`, `scrubConfig()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (3 nodes): `CronBuilder.tsx`, `CronBuilder()`, `describe()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `String()` connect `Community 11` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 31`, `Community 33`, `Community 34`, `Community 36`, `Community 39`, `Community 41`, `Community 47`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `replace()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 17`, `Community 19`, `Community 23`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 34`, `Community 35`, `Community 36`, `Community 39`, `Community 41`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `parse()` connect `Community 9` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 25`, `Community 26`, `Community 29`, `Community 33`, `Community 34`, `Community 39`, `Community 42`, `Community 47`?**
